...
{{
    ...
    "timeline": [
        {{
            "date": "วันเวลาที่เริ่มสนทนาของ Session (เช่น '14 ก.ค. 2026 เวลา 13:30 น.')",
...
หมายเหตุ:
- ห้าม Hallucinate เด็ดขาด: สรุปเฉพาะข้อมูลที่ปรากฏจริงในบทสนทนาเท่านั้น ห้ามเติม/เดา/สมมติข้อมูลที่ผู้ใช้ไม่ได้ให้
  - โดยเฉพาะ "allergies": ใส่เฉพาะเมื่อผู้ป่วย/เภสัชกรระบุประวัติแพ้ยาไว้จริง ถ้าไม่มีการระบุให้ใส่ [] (ห้ามสรุปว่าแพ้ยาเอง)
  - "conditions" และ "medications_given": ใส่เฉพาะที่พบในบทสนทนาจริง
- ถ้าข้อมูลจากแชทไม่เพียงพอที่จะสรุปครบทุกฟิลด์ ให้ "data_sufficient": false และใส่เฉพาะข้อมูลที่มี
- สำหรับฟิลด์ "date" ใน "timeline" ให้ใช้ วันเวลาเริ่มต้นของ Session นั้นๆ ที่ระบุในบรรทัดหัวข้อ "--- Session: ... (เริ่ม: ...) ---" โดยตรง นำมาแปลงเป็นรูปแบบภาษาไทยที่อ่านง่ายและชัดเจน เช่น "14 ก.ค. 2026 เวลา 13:30 น." ห้ามสมมติหรือเขียนวันที่เองเด็ดขาด
